...
COURSE_OPTIONS = [
    {
        ...
        "curso": "FORMAÇÃO DE RECEPCIONISTA DE EXCELÊNCIA",
        "turma": "TURMA RECEPCIONISTA 01",
        "dias_aula": "Sábado",
        "horario": "08h até 12h",
                        ...
                        <div class="hero-card">
                            ...
                            <p class="hero-subtitle">
                                Capacitação Profissional com Ênfase em Novas Tecnologias para Ingresso e Permanência no Mercado de Trabalho!<br>
                                    📍Local: Avenida Geremário Dantas, 1400 - Central do Trabalhador de Jacarepaguá
                            </p>
                            <div class="hero-highlights">
                                <div class="hero-highlight">
                                    <strong>CONTEÚDO</strong>
                                        PÚBLICO, TELEFÔNICO E DIGITAL<br>
                                        ETIQUETA E MARKETING PESSOAL<br>
                                        INFORMÁTICA E ARQUIVO<br>
                                        AGENDA E DOCUMENTOS<br>
                                ...
                                <div class="hero-highlight">
                                    ...
                                    👥Capacitação Profissional Completa<br>
                                        ...
                                        ⭐Atendimento e Encantamento ao Cliente<br>
                                        👔Imagem e Postura Profissional<br>
                                        📂Domínio Administrativo<br>
                                        ⏳Gestão de Tempo e Produtividade<br>
                                        🤝Relacionamento Profissional de Sucesso
                                </div>
                                <div class="hero-highlight">
                    ...
                    <div class="step-card">
                        ...
                        <div class="step-grid step-grid--stacked">
                            <div class="form-group">
                                ...
                                <input type="text" id="local" name="local" class="readonly-field" readonly value="{{ form_data.get('local', 'CENTRAL DO TRABALHADOR DE JACAREPAGUÁ') }}">
                            </div>
                        ...
                        <div class="review-layout">
                            ...
                            <div class="review-box full">
                                <div class="review-info-text" style="margin-bottom:10px; color:#2f6a55; font-size:0.98rem; text-align:left;">
                                    <strong>Elegibilidade:</strong> Este curso é destinado a pessoas com 18 anos ou mais interessadas em qualificação profissional na área de recepção, atendimento e rotinas administrativas.
                                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function aplicarOpcaoCurso(optionId) {
                ...
                if (!option) {
                    localInput.value = 'CENTRAL DO TRABALHADOR DE JACAREPAGUÁ';
                    cursoInput.value = '';
                    turmaInput.value = '';
                    diasAulaInput.value = '';
                    horarioInput.value = '';
